...
class TourOperatorController extends Controller
{
	...
	{
		$tours = Tour::where('tour_tour_operator_serial', '=', $id)->get();
	...
	public function getTour($id, $tourId)
	{
		...
		$tours = Tour::where('tour_tour_operator_serial', '=', $id)->where('serial', '=', $tourId)->get();
	...
	public function updateTour(Requets $requets, $id, $tourId) {
