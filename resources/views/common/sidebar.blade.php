    ...
    <aside id="sidebar" class="fixed h-screen z-10 w-64 border showdow-md overflow-y-auto">
        <div class="h-full pt-16 overflow-y-auto py-4 px-3 bg-white rounded dark:bg-gray-800">
            ...
            <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="#"
                        class="group flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        <svg aria-hidden="true"
