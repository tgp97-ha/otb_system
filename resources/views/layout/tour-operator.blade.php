...
<body>
    <div id="dashboard-tour-operator" class="container mx-auto py-3">
        ...
        <aside id="sidebar" class="fixed">
            <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="/tour-operator"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Tour Management</span>
                        </a>
                    </li>
                    {{-- Analysis --}}
                    <li>
                        <a href="/tour-operator/analysis"
                            class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg  hover:bg-gray-100 ">
                            <svg aria-hidden="true"
                                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75  group-hover:text-gray-900 "
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100  ">
                            <svg aria-hidden="true"
                                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75  group-hover:text-gray-900 "
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
        ...
        {{-- Content --}}
        <main id="main-content" class="h-full ml-56 p-4 relative shadow-md sm:rounded-lg">
            @yield('content')
        </main>
