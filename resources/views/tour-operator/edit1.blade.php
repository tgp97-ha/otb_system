        ...
        <div class="grid gap-6 px-[30%]">
            ...
            <div>
                ...
                <input type="text" id="name"
                    ...
                    name="name" value="{{ $tourOperator->tour_operator_name ?? '' }}" placeholder="" required autofocus>
                {{-- Error --}}
                @if ($errors->has('name'))
            ...
            <div>
                ...
                <input type="text" id="company"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="description" value="{{ $tourist->tour_operator_description ?? '' }}" placeholder="" required>
                {{-- Error --}}
            ...
            <div>
                ...
                <input type="number" id="tax"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="tax_number" value="{{ $tourist->tour_operator_tax_number ?? '' }}" placeholder="" required>
                {{-- Error --}}
