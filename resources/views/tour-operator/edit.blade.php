...
@section('content')
    ...
    {{-- Edit Form --}}
    <form method="POST" action="/tour-operator/tours/{{ $tour['id'] }}" enctype="multipart/form-data"
        ...
        <div class="col-span-3">
            ...
            <input type="text"
                ...
                value="{{ $tour['name'] }}" placeholder=" " required>
        </div>
        <div class="col-span-3">
            <label class="block mb-2 text-sm font-medium text-gray-900 ">
                Title
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value="{{ $tour['title'] }}" placeholder=" " required>
        </div>
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-900 ">
                Destination
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value="{{ $tour['destination'] }}" placeholder=" " required>
        </div>
        ...
        <div>
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value="{{ $tour['day_length'] }}" placeholder=" " required>
        </div>
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-900 ">
                Night Length
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value="{{ $tour['night_length'] }}" placeholder=" " required>
        </div>
        ...
        <div class="relative">
            ...
            <input inline-datepicker datepicker-buttons datepicker-format="dd/mm/yyyy" value="{{ $tour['start_date'] }}"
        ...
        <div>
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value="{{ $tour['slots'] }}" placeholder=" " required>
        </div>
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-900 ">
                Slots Left
            ...
            <input type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value="{{ $tour['slots_left'] }}" placeholder=" " required>
        </div>
        <div class="col-span-3">
            <label class="block mb-2 text-sm font-medium text-gray-900 ">
                Detail
            ...
            <textarea rows="5"
                ...
                placeholder="Tour detail...">{{ $tour['detail'] }}</textarea>
        </div>
        <div class="col-span-3">
            <label class="block mb-2 text-sm font-medium text-gray-900 ">
                Description
            ...
            <textarea rows="10"
                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
                placeholder="Tour description...">{{ $tour['description'] }}</textarea>
        </div>
        <div class="col-span-3">
            <label class="block mb-2 text-sm font-medium text-gray-900">
                Tour Images
