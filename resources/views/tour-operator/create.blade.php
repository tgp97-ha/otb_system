    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">Register as tour operator</div>
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ route('tour-operator.store') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group col-md-10 offset-md-1" {{ $errors->has('description') ? ' has-error' : '' }}>
