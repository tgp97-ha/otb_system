<aside class="fixed top-0 left-0 w-64 h-screen pt-16 z-10" aria-label="Sidebar">
    <div class="h-full overflow-y-auto py-4 px-3 bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2">
            <li>
                <a href="{{ url('tour-operator/dashboard') }}"
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Create Tour</span>
                </a>
            </li>
            <li>
                <a href="#"
