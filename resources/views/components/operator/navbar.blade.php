<nav class="fixed top-0 left-0 w-full h-20 z-20 bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="{{ url('tour-operator') }}" class="flex items-center">
            ...
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Online Tour Booking</span>
        </a>
        <div class="flex items-center md:order-2">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="{{ asset('images/default_avatar.png') }}" alt="user photo">
            </button>
            <!-- Dropdown menu -->
