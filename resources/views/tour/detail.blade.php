                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group col-md-10 offset-md-1 row">
                            ...
                            <span
                                class="col-form-label font-weight-normal  col-8 align-middle">{{ $tour->tour_title }}</span>
                        </div>
                        <div class="form-group col-md-10 offset-md-1 row">
                            <span class="col-form-label col-4 align-middle">Tour Place</span>
                            <span
                                class="col-form-label font-weight-normal  col-8 align-middle">{{ $tour->place->place_name }}</span>
                        </div>
                        <div class="form-group col-md-10 offset-md-1 row">
                            <span class="col-form-label col-4 align-middle">Tour Description</span>
                            <span
                                class="col-form-label font-weight-normal  col-8 align-middle d-inline-block">{{ $tour->tour_description }}</span>
                        </div>
                        <div class="form-group col-md-10 offset-md-1 row">
                            <span class="col-form-label col-4 align-middle">Tour Detail</span>
                            <span
                                class="col-form-label font-weight-normal  col-8 align-middle d-inline-block">{{ $tour->tour_detail }}</span>
                        </div>
                        <div class="form-group col-md-10 offset-md-1 row">
                            <span class="col-form-label col-4 align-middle">Tour Length</span>
                            <span
                                class="col-form-label font-weight-normal align-middle col-8">{{ $tour->tour_day_length . ' days ' . $tour->tour_night_length . ' nights' }}</span>
                        </div>
                        <div class="form-group col-md-10 offset-md-1 row">
                            <span class="col-form-label col-4 align-middle">Tour Price</span>
                            <span
                                class="col-form-label font-weight-normal align-middle col-8">{{ $tour->tour_prices . ' VND' }}</span>
                        </div>
                        <div class="form-group col-md-10 offset-md-1 row">
                            ...
                            <div class="col-8">
                                @foreach ($tour->services as $service)
                                    <div class="row">
                                        <div class="col">
                                            <span
                                                class="col-form-label font-weight-normal align-middle">{{ $service->service_name }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @canany(['admin', 'tour-operator'])
                            <div class="form-group col-md-10 offset-md-1 row">
                                ...
                                <span
                                    class="col-form-label font-weight-normal align-middle col-8">{{ $tour->tour_slots }}</span>
                            </div>
                            <div class="form-group col-md-10 offset-md-1 row">
                                <span class="col-form-label col-4 align-middle">Tour Slot Left</span>
                                <span
                                    class="col-form-label font-weight-normal align-middle col-8">{{ $tour->tour_slots_left }}</span>
                            </div>
                        ...
                        @if (isset($booking))
                            <form class="form-horizontal" method="POST"
                                action="{{ url('tour/comment/' . $tour->serial) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group col-md-10 offset-md-1 row">
                                    <label for="comment" class="col-form-label col-4 align-middle">Comment</label>
                                    <textarea id="comment" class="col-form-label font-weight-normal align-middle col-8" name="comment"></textarea>
                                </div>
